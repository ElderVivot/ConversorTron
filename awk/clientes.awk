...
}
{
	...
	print codi_emp, codi_cli_for, esta_emp, codi_cta, codm_cli_for, fantasia_emp, nome_emp, ende_emp, nume_emp, cida_cli_for, cepe_emp, cgc, ins_est, fone_emp, fax,
	      agro_cli_for, icms_cli_for, tipo_ins, ddd_emp, aliq_cli_for, ins_mun, bair_emp, origem_reg, categoria_estabel_cli_for, regime_cli_for, orgao_pub_federal_cli_for,
		  codigo_pais, cod_cidade, insc_suframa, comp_emp, cadastro_cli_for, conta_for_cli, tipo_assinante_cli_for, possui_interdependencia_cli_for, iestst_cli_for,
		  agente_regulado_cli_for, codigo_instalacao_cli_for, participante_fome_zero, i_cnae20, percentual_carga_media, varejista_ou_consumidor_final_cli_for,
